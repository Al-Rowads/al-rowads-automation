...
def test_open_whatsapp_marks_complete_and_encodes_message(client):
    import_file(client, b"+989121234567\n")
    ...
    assert parsed_url.path == "/989121234567"
...
def test_uncheck_and_filters_persist(client):
    ...
    searched = client.get("/api/contacts?q=97150").get_json()
    ...
    assert searched["contacts"][0]["phone"] == "+971501234567"
